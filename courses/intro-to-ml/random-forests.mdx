...
That's it for Introduction to ML! Congratulations. You've already picked up the basics and built your first model. I hope you'll join us in the <Link href="/courses/intermediate-ml">next course</Link>, where we'll look into modern techniques to make even better predictions.
